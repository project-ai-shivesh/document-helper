...
def retrieve_context(query:str):
    ...
    #Return both serialized content and raw content
    return serialized, retrieve_docs

def run_llm(query:str) -> Dict[str, Any]:
    """
    Run the RAG pipeline to answer a query using retrieved documwntation.
    Args:
        query: Tuser's question
    Returns:
    ...
    for message in response["messages"]:
        #check if it is a ToolMessage with artifact
